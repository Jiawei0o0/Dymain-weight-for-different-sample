...
def Inference(FLAGS):
    ...
    snapshot_path = "/mnt/imtStu/jwsu/mcnet/ACDC3/{}_{}_labeled/{}".format(FLAGS.exp, FLAGS.labelnum, FLAGS.model)
    test_save_path = "/mnt/imtStu/jwsu/mcnet/ACD3/{}_{}_labeled/{}_predictions/".format(FLAGS.exp, FLAGS.labelnum, FLAGS.model)
