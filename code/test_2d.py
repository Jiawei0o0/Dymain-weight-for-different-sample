    ...
    for ind in range(image.shape[0]):
        ...
        with torch.no_grad():
            ...
            if len(out_main) == 2:
                ...
                out_main = (out_main[0] + out_main[1] + out_main[2]) / 3.
...
def Inference(FLAGS):
    ...
    # /mnt/imtStu/jwsu/mine2/ACDC_1_iouexp_MCNet_3_labeled
    # 3/ACDC_dicebatch_double_outputs_all_MCNet_3_labeled
    snapshot_path = "/mnt/imtStu/jwsu/WeightSample/ACDC_all_{}_{}_labeled/{}".format(
        FLAGS.exp, FLAGS.labelnum, FLAGS.model)
    test_save_path = "/mnt/imtStu/jwsu/WeightSample/ACDC_all_{}_{}_labeled/{}_predictions/".format(
        FLAGS.exp, FLAGS.labelnum, FLAGS.model)
